...
router.post('/creating', categoryController.category_create_post)

router.get('/update/:id', categoryController.category_update_get)
router.post('/updating/:id', categoryController.category_update_post)

router.get('/delete/:id', categoryController.category_delete_get)
router.post('/deleting/:id', categoryController.category_delete_post)
